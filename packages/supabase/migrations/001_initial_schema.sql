...
CREATE TABLE IF NOT EXISTS public.tasting_logs (
  ...
  flavor NUMERIC(3,1) NOT NULL DEFAULT 7.5,
  ...
  uniformity NUMERIC(3,1) NOT NULL DEFAULT 10.0,
  clean_cup NUMERIC(3,1) NOT NULL DEFAULT 10.0,
  sweetness NUMERIC(3,1) NOT NULL DEFAULT 10.0,
  overall NUMERIC(3,1) NOT NULL DEFAULT 7.5,
  clarity NUMERIC(3,1) DEFAULT 7.5,
