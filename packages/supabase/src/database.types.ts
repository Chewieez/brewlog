  ...
  public: {
    Tables: {
      ...
      recipe_stages: {
        ...
        Update: Partial<Database["public"]["Tables"]["recipe_stages"]["Insert"]>;
        Relationships: [];
      };
      tasting_logs: {
        Row: {
        ...
        Update: Partial<Database["public"]["Tables"]["tasting_logs"]["Insert"]>;
        Relationships: [];
      };
    };
    Views: {
...
export type BeanRow = Tables<"beans">;
export type BeanInsert = TablesInsert<"beans">;
export type TastingLogRow = Tables<"tasting_logs">;
export type TastingLogInsert = TablesInsert<"tasting_logs">;
...
export type RecipeStageRow = Tables<"recipe_stages">;
export type RecipeStageInsert = TablesInsert<"recipe_stages">;
