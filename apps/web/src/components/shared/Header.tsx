      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          >
            ...
            <div>
              <span className="text-lg sm:text-xl font-bold tracking-tight bg-gradient-to-r from-stone-100 via-amber-100 to-amber-400 bg-clip-text text-transparent">
                BrewLog
              </span>
              <span className="hidden xl:inline-block ml-2 px-2 py-0.5 text-[10px] font-semibold tracking-wider uppercase rounded-full bg-amber-500/10 text-amber-400 border border-amber-500/20">
                Specialty
              </span>
            </div>
          </div>
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span>{tab.label}</span>
                {tab.badge !== undefined && tab.badge > 0 && (
                  <span className="ml-1 px-1.5 py-0.2 text-[10px] font-bold rounded-full bg-stone-800 text-stone-300">
                    {tab.badge}
                  </span>
                )}
              </button>
